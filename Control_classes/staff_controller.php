...
*/
	 ...
	 //set values to the variables
		...
		$staffClass->staff_date_birth =  $_GET['date_birth'];
		...
		//$day_graduated = $_GET['year_graduation'];
		//$month_graduated = $_GET['month_graduated'];
		//$year_graduated = $_GET['year_graduated'];
		$staffClass->staff_year_graduated = $_GET['year_graduation'];
		
			//$apointment_day = $_GET['apointment_date'];
		//$apointment_month = $_GET['apointment_month'];
		//$apointment_year = $_GET['apointment_year'];
		$staffClass->staff_year_of_appointment = $_GET['apointment_date'];
	...
	$getstaff = $staffClass->AvoidStaffDuplicate();
	 ...
	 if( isset($getstaff)&& $getstaff > 0) {
	  ...
	  header("location:../Admin/Register_staff.php?err=3");
		...
		elseif(empty($_GET['sex'])  || empty($_GET['marital'] ) ){
