...
<center>
	...
	<td>
            ...
            <td colspan="2">STUDENT AVERAGE:<?php echo number_format(($createscore->avg_total_marks/$total_subjects_by_student ),1)."%";?></td></tr>
				<tr><td colspan="2">CLASS:<?php echo $studentclass->class_name. $classarm->class_arm_name?></td> <td colspan="2">NUMBER IN CLASS:<?php echo $total_students; ?></td><td colspan="2">NEXT TERM BEGIN:04/04/2020</td><td></td></tr>
				
            
               
               
				<tr><td colspan="2">DAYS SCHOOL OPENED:120</td><td colspan="3">POSITION IN CLASS:<?php echo $student_class_postion?><sup><?php echo $printsufix; ?></sup></td><td colspan="4"></td></tr>
