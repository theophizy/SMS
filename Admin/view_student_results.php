...
?>
<center>
	<table border=1 style=" max-width:2780px; width:100%;" class="table-responsive">
		<tr>
		<td>
			<table  width="100%">
			<tr>
   ...
   <button id="print" class="btn btn-primary btn-block" onClick="printContent('printResult');" >print</button>
    <?php //} ?>
</center>
</div>
</div></div></div>
