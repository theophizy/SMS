...
<?php  include_once('metadatda.php'); ?>
  <title>Manage Principal's Remarks</title>
...
?></div><div class="clearfix"></div>
                    <div class="card">
                    <div class="btn btn-reddit btn-block"> <strong>Select Items to View and Edit Remarks</strong> </div>
   ...
   <?php
	...
	if(!empty($schoolsetup->view_principalRemarkByTermandSession())){
   ...
   ?>
            ...
            <div class="box-header">
              <h3 class="box-title">Availabe Principal's Remarks</h3>
               <strong><hr /></strong>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                <thead>
				  ...
				  foreach($schoolsetup->view_principalRemarkByTermandSession() as $key => $val){
...
<form method="POST" action="../Control_classes/schoolsetup_controller.php?action=Edit_principal_remark">
				<div class="modal-header">
                <div class="btn btn-reddit btn-block"> <strong>Edit Information</strong> </div>
