...
?></div><div class="clearfix"></div>
 <div class="btn btn-reddit btn-block"> <strong>Pay Alumni Debts</strong> </div>
 <strong><hr /></strong>
     <div class="col-md-8">
     <form method="POST" action="../Control_classes/feeitem_controller.php?action=Pay_alumni_debt">
				<div class="modal-header">
					<h3 class="modal-title">Pay Fee</h3>
				</div>
