...
<?php  include_once('metadatda.php'); ?>
  <title>Create Academic Seesion</title>
...
?></div><div class="clearfix"></div>
 ...
 <div class="col-lg-10">
                    ...
                    <div class="card">
                      <div class="btn btn-reddit btn-block"> <strong>Create Session </strong> </div>
                        <strong><hr></strong>
                      
                      <div class="card-body card-block">
                        <form action="../Control_classes/session_controller.php?action=createsession" method="post" enctype="multipart/form-data" class="form-horizontal" name="postForm" onSubmit="return ValidatePost();">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-3 col-md-4"><input type="text" id="session_description" name="session_description" placeholder="E.g 2017/2018" class="form-control"  onKeyUp="this.value=this.value.toUpperCase();" required></div>
                          </div>
