...
<?php  include_once('metadatda.php'); ?>
  <title>Create Cognitive Skills</title>
...
?></div><div class="clearfix"></div>
 ...
 <div class="col-lg-10">
                    ...
                    <div class="card">
                     <div class="btn btn-reddit btn-block"> <strong>Create Cognitive Skills</strong> </div>
                        <strong><hr></strong> 
                      </div>
                      
                      <div class="card-body card-block">
                        <form action="../Control_classes/schoolsetup_controller.php?action=createcognitive" method="post" enctype="multipart/form-data" class="form-horizontal" name="postForm" onSubmit="return ValidatePost();">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-3 col-md-4"><input type="text" id="cog_name" name="cog_name" placeholder="E.g Integrity" class="form-control"  required></div>
                          </div>
