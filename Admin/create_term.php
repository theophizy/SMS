...
?></div><div class="clearfix"></div>
 ...
 <div class="col-lg-10">
                    ...
                    <div class="card">
                     <div class="btn btn-reddit btn-block"> <strong>Create Term </strong> </div>
                        <strong><hr></strong>
                      
                      
                      <div class="card-body card-block">
                        <form action="../Control_classes/term_controller.php?action=createterm" method="post" enctype="multipart/form-data" class="form-horizontal" name="postForm" onSubmit="return ValidatePost();">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-3 col-md-4"><input type="text" id="term_name" name="term_name" placeholder="E.g First Term" class="form-control"  required></div>
                          </div>
