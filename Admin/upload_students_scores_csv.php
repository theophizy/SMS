...
$avialablesessions = new Session_class();
 ...
 <div class="col-lg-10">
                    ...
                    <div class="card">
                      <div class="card-header" align="center">
                        <strong>Import Students Scores . pls save your file in cvs format (CSV Format)</strong> 
                      <a href="downloadcsv.php"  class="btn btn-info" >Download CSV Format</a>
                      </div><br>
                      
                      <div class="card-body card-block">
                        <form action="../Control_classes/Scores_controller.php?action=uploadscores" method="POST" enctype="multipart/form-data" class="form-horizontal" name="postForm" onSubmit="return ValidatePost();">
...
<div class="col col-md-2">     
    ...
    <div class="col col-md-3">
     ...
     <div class="col col-md-3">
       <p id="subjectid"></p></div>
     </div>
     <div class="row form-group">
     
     <div class="col col-md-3">
      <select name="session" onselect="this.className" class="form-control">
      
      <?php
	  
	  foreach($avialablesessions->viewAllSession() as $key => $val){  
	  ?>
