...
/*
	...
	`teach_nonteach` enum('teaching','nonteaching') NOT NULL,
	`hrdsid` VARCHAR(255) NOT NULL, PRIMARY KEY  (`es_staffid`)) ENGINE=MyISAM;
*/
...
public $date;
	...
	/**
	 * @var enum('selected','notselected','onhold','added','dismisied')
	 */
	public $status;
	...
	/**
	 * @var enum('issued', 'notissued', 'accepted', 'notaccepted')
	 */
	public $selstatus;
	
	/**
	 * @var  	enum('notissued', 'issued')
	 */
	public $tcstatus;
	 ...
	 * @var VARCHAR(255)
	 */
	public $st_permissions;
	
	/**
	 * @var VARCHAR(255)
	 */
	public $st_bloodgroup;
	
	/**
	 * @var enum('teaching','nonteaching')
	 */
	public $teach_nonteach;
	...
	public $pog_attribute_type = array(
		...
		"st_fthname" => array('db_attributes' => array("TEXT", "VARCHAR", "255")),
		...
		"st_noofsons" => array('db_attributes' => array("VARCHAR", "255")),
		"st_marital" => array('db_attributes' => array("VARCHAR", "255")),
		"st_experience" => array('db_attributes' => array("VARCHAR", "255")),
		"st_category" => array('db_attributes' => array("VARCHAR", "255")),
		...
		"mamber1" => array('db_attributes' => array("TEXT", "VARCHAR", "255")),
		"age1" => array('db_attributes' => array("NUMERIC", "INT")),
		"relation1" => array('db_attributes' => array("TEXT", "VARCHAR", "255")),
		"education1" => array('db_attributes' => array("TEXT", "VARCHAR", "255")),
		"occupation1" => array('db_attributes' => array("TEXT", "VARCHAR", "255")),
		"mamber2" => array('db_attributes' => array("TEXT", "VARCHAR", "255")),
		"age2" => array('db_attributes' => array("NUMERIC", "INT")),
		"relation2" => array('db_attributes' => array("TEXT", "VARCHAR", "255")),
		"education2" => array('db_attributes' => array("TEXT", "VARCHAR", "255")),
		"occupation2" => array('db_attributes' => array("TEXT", "VARCHAR", "255")),
		"mamber3" => array('db_attributes' => array("TEXT", "VARCHAR", "255")),
		"age3" => array('db_attributes' => array("NUMERIC", "INT")),
		"relation3" => array('db_attributes' => array("TEXT", "VARCHAR", "255")),
		"education3" => array('db_attributes' => array("TEXT", "VARCHAR", "255")),
		"occupation3" => array('db_attributes' => array("TEXT", "VARCHAR", "255")),
		"mamber4" => array('db_attributes' => array("TEXT", "VARCHAR", "255")),
		"age4" => array('db_attributes' => array("NUMERIC", "INT")),
		"relation4" => array('db_attributes' => array("TEXT", "VARCHAR", "255")),
		"education4" => array('db_attributes' => array("TEXT", "VARCHAR", "255")),
		"occupation4" => array('db_attributes' => array("TEXT", "VARCHAR", "255")),
		"mamber5" => array('db_attributes' => array("TEXT", "VARCHAR", "255")),
		"age5" => array('db_attributes' => array("NUMERIC", "INT")),
		"relation5" => array('db_attributes' => array("TEXT", "VARCHAR", "255")),
		"education5" => array('db_attributes' => array("TEXT", "VARCHAR", "255")),
		"occupation5" => array('db_attributes' => array("TEXT", "VARCHAR", "255")),
		...
		"st_hobbies" => array('db_attributes' => array("TEXT", "VARCHAR", "255")),
		"st_attach1" => array('db_attributes' => array("TEXT", "VARCHAR", "255")),
		"st_attach2" => array('db_attributes' => array("TEXT", "VARCHAR", "255")),
		"st_attach3" => array('db_attributes' => array("TEXT", "VARCHAR", "255")),
		"st_attach4" => array('db_attributes' => array("TEXT", "VARCHAR", "255")),
		...
		"status" => array('db_attributes' => array("SET", "ENUM", "'selected','notselected','onhold','added','dismisied'")),
		...
		"intdate" => array('db_attributes' => array("NUMERIC", "DATE")),
		"image" => array('db_attributes' => array("TEXT", "VARCHAR", "255")),
		"selstatus" => array('db_attributes' => array("SET", "ENUM", "'issued', 'notissued', 'accepted', 'notaccepted'")),
		"tcstatus" => array('db_attributes' => array("SET", "ENUM", "'notissued', 'issued'")),
		"st_username" => array('db_attributes' => array("TEXT", "VARCHAR", "255")),
		"st_password" => array('db_attributes' => array("TEXT", "VARCHAR", "255")),
		"st_theme" => array('db_attributes' => array("TEXT", "VARCHAR", "255")),
		"st_class" => array('db_attributes' => array("TEXT", "VARCHAR", "255")),
		"st_subject" => array('db_attributes' => array("TEXT", "VARCHAR", "255")),
		...
		"st_permissions" => array('db_attributes' => array("TEXT", "VARCHAR", "255")),
		"st_bloodgroup" => array('db_attributes' => array("TEXT", "VARCHAR", "255")),
		"teach_nonteach" => array('db_attributes' => array("SET", "ENUM", "'teaching','nonteaching'")),
		"hrdsid" => array('db_attributes' => array("TEXT", "VARCHAR", "255")),
		);
	public $pog_query;
	...
	*/
	...
	function es_staff($st_postaplied='', $st_firstname='', $st_lastname='', $st_gender='', $st_dob='', $st_primarysubject='', $st_fatherhusname='', $st_noofdughters='', $st_noofsons='', $st_marital='', $st_experience='', $st_category='', $st_email='', $st_mobilenocomunication='', $st_examp1='', $st_examp2='', $st_examp3='',$mamber1='', $age1='', $relation1='', $education1='', $occupation1='', $mamber2='', $age2='', $relation2='', $education2='', $occupation2='', $mamber3='', $age3='', $relation3='', $education3='', $occupation3='', $mamber4='', $age4='', $relation4='', $education4='', $occupation4='', $mamber5='', $age5='', $relation5='', $education5='', $occupation5='',$st_borduniversity1='', $st_borduniversity2='', $st_borduniversity3='', $st_year1='', $st_year2='', $st_year3='', $st_insititute1='', $st_insititute2='', $st_insititute3='', $st_position1='', $st_position2='', $st_position3='', $st_period1='', $st_period2='', $st_period3='', $st_pradress='', $st_hobbies='', $st_attach1='', $st_attach2='', $st_attach3='', $st_attach4='', $st_prcity='', $st_prpincode='', $st_prphonecode='', $st_prstate='', $st_prresino='', $st_prcountry='', $st_prmobno='', $st_peadress='', $st_pecity='', $st_pepincode='', $st_pephoneno='', $st_pestate='', $st_peresino='', $st_pecountry='', $st_pemobileno='', $st_refposname1='', $st_refposname2='', $st_refposname3='', $st_refdesignation1='', $st_refdesignation2='', $st_refdesignation3='', $st_refinsititute1='', $st_refinsititute2='', $st_refinsititute3='', $st_refemail1='', $st_refemail2='', $st_refemail3='', $st_writentest='', $st_technicalinterview='', $st_finalinterview='', $status='', $st_perviouspackage='', $st_basic='', $st_dateofjoining='', $st_post='', $st_department='', $st_remarks='', $intdate='', $image='', $selstatus='', $tcstatus='', $st_username='', $st_password='', $st_theme='', $st_class='', $st_subject='', $st_qualification='', $st_marks1='', $st_marks2='', $st_marks3='', $st_permissions='', $st_bloodgroup='', $teach_nonteach='', $hrdsid='')
	{
		...
		$this->st_marital = $st_marital;
		$this->st_experience = $st_experience;
		...
		$this->st_hobbies = $st_hobbies;
		$this->st_attach1 = $st_attach1;
		$this->st_attach2 = $st_attach2;
		$this->st_attach3 = $st_attach3;
		$this->st_attach4 = $st_attach4;
		...
		$this->st_permissions = $st_permissions;
		$this->st_bloodgroup = $st_bloodgroup;
	...
	*/
	...
	function Get($es_staffId)
	{
		...
		while ($row = Database::Read($cursor))
		{
			...
			$this->st_fthname = $this->Unescape($row['st_fthname']);
			...
			$this->st_marital = $this->Unescape($row['st_marital']);
			$this->st_experience = $this->Unescape($row['st_experience']);
			$this->st_category = $this->Unescape($row['st_category']);
			...
			$this->mamber1 = $this->Unescape($row['mamber1']);
			$this->age1 = $this->Unescape($row['age1']);
			$this->relation1 = $this->Unescape($row['relation1']);
			$this->education1 = $this->Unescape($row['education1']);
			$this->occupation1 = $this->Unescape($row['occupation1']);
			$this->mamber2 = $this->Unescape($row['mamber2']);
			$this->age2 = $this->Unescape($row['age2']);
			$this->relation2 = $this->Unescape($row['relation2']);
			$this->education2 = $this->Unescape($row['education2']);
			$this->occupation2 = $this->Unescape($row['occupation2']);
			$this->mamber3 = $this->Unescape($row['mamber3']);
			$this->age3 = $this->Unescape($row['age3']);
			$this->relation3 = $this->Unescape($row['relation3']);
			$this->education3 = $this->Unescape($row['education3']);
			$this->occupation3 = $this->Unescape($row['occupation3']);
			$this->mamber4 = $this->Unescape($row['mamber4']);
			$this->age4 = $this->Unescape($row['age4']);
			$this->relation4 = $this->Unescape($row['relation4']);
			$this->education4 = $this->Unescape($row['education4']);
			$this->occupation4 = $this->Unescape($row['occupation4']);
			$this->mamber5 = $this->Unescape($row['mamber5']);
			$this->age5 = $this->Unescape($row['age5']);
			$this->relation5 = $this->Unescape($row['relation5']);
			$this->education5 = $this->Unescape($row['education5']);
			$this->occupation5 = $this->Unescape($row['occupation5']);
			...
			$this->st_hobbies = $this->Unescape($row['st_hobbies']);
			$this->st_attach1 = $this->Unescape($row['st_attach1']);
			$this->st_attach2 = $this->Unescape($row['st_attach2']);
			$this->st_attach3 = $this->Unescape($row['st_attach3']);
			$this->st_attach4 = $this->Unescape($row['st_attach4']);
			...
			$this->intdate = $row['intdate'];
			$this->image = $this->Unescape($row['image']);
			$this->selstatus = $row['selstatus'];
			$this->tcstatus = $this->Unescape($row['tcstatus']);
			...
			$this->st_subject = $this->Unescape($row['st_subject']);
			...
			$this->st_permissions = $this->Unescape($row['st_permissions']);
			$this->st_bloodgroup = $this->Unescape($row['st_bloodgroup']);
			$this->teach_nonteach = $row['teach_nonteach'];
			$this->hrdsid = $this->Unescape($row['hrdsid']);
		}
		return $this;
	}
	...
	*/
	function GetList($fcv_array = array(), $sortBy='', $ascending=true, $limit='')
	{
		...
		while ($row = Database::Read($cursor))
		{
			...
			$es_staff->st_fthname = $this->Unescape($row['st_fthname']);
			...
			$es_staff->st_marital = $this->Unescape($row['st_marital']);
			$es_staff->st_experience = $this->Unescape($row['st_experience']);
			$es_staff->st_category = $this->Unescape($row['st_category']);
			...
			$es_staff->mamber1 = $this->Unescape($row['mamber1']);
			$es_staff->age1 = $this->Unescape($row['age1']);
			$es_staff->relation1 = $this->Unescape($row['relation1']);
			$es_staff->education1 = $this->Unescape($row['education1']);
			$es_staff->occupation1 = $this->Unescape($row['occupation1']);
			$es_staff->mamber2 = $this->Unescape($row['mamber2']);
			$es_staff->age2 = $this->Unescape($row['age2']);
			$es_staff->relation2 = $this->Unescape($row['relation2']);
			$es_staff->education2 = $this->Unescape($row['education2']);
			$es_staff->occupation2 = $this->Unescape($row['occupation2']);
			$es_staff->mamber3 = $this->Unescape($row['mamber3']);
			$es_staff->age3 = $this->Unescape($row['age3']);
			$es_staff->relation3 = $this->Unescape($row['relation3']);
			$es_staff->education3 = $this->Unescape($row['education3']);
			$es_staff->occupation3 = $this->Unescape($row['occupation3']);
			$es_staff->mamber4 = $this->Unescape($row['mamber4']);
			$es_staff->age4 = $this->Unescape($row['age4']);
			$es_staff->relation4 = $this->Unescape($row['relation4']);
			$es_staff->education4 = $this->Unescape($row['education4']);
			$es_staff->occupation4 = $this->Unescape($row['occupation4']);
			$es_staff->mamber5 = $this->Unescape($row['mamber5']);
			$es_staff->age5 = $this->Unescape($row['age5']);
			$es_staff->relation5 = $this->Unescape($row['relation5']);
			$es_staff->education5 = $this->Unescape($row['education5']);
			$es_staff->occupation5 = $this->Unescape($row['occupation5']);
			...
			$es_staff->st_hobbies = $this->Unescape($row['st_hobbies']);
			$es_staff->st_attach1 = $this->Unescape($row['st_attach1']);
			$es_staff->st_attach2 = $this->Unescape($row['st_attach2']);
			$es_staff->st_attach3 = $this->Unescape($row['st_attach3']);
			$es_staff->st_attach4 = $this->Unescape($row['st_attach4']);
			...
			$es_staff->intdate = $row['intdate'];
			$es_staff->image = $this->Unescape($row['image']);
			$es_staff->selstatus = $row['selstatus'];
			$es_staff->tcstatus = $this->Unescape($row['tcstatus']);
			...
			$es_staff->st_class = $this->Unescape($row['st_class']);
			$es_staff->st_subject = $this->Unescape($row['st_subject']);
			$es_staff->st_qualification = $this->Unescape($row['st_qualification']);
			$es_staff->st_marks1 = $this->Unescape($row['st_marks1']);
			$es_staff->st_marks2 = $this->Unescape($row['st_marks2']);
			$es_staff->st_marks3 = $this->Unescape($row['st_marks3']);
			$es_staff->st_permissions = $this->Unescape($row['st_permissions']);
			$es_staff->st_bloodgroup = $this->Unescape($row['st_bloodgroup']);
			$es_staff->teach_nonteach = $row['teach_nonteach'];
			$es_staff->hrdsid = $this->Unescape($row['hrdsid']);
	...
	*/
	...
	function Save()
	{
		...
		if ($rows > 0)
		{
			...
			`st_marital`='".$this->Escape($this->st_marital)."',
			`st_experience`='".$this->Escape($this->st_experience)."',
			`st_category`='".$this->Escape($this->st_category)."',
			...
			`mamber1`='".$this->Escape($this->mamber1)."',
			`age1`='".$this->Escape($this->age1)."',
			`relation1`='".$this->Escape($this->relation1)."',
			`education1`='".$this->Escape($this->education1)."',
			`occupation1`='".$this->Escape($this->occupation1)."',
			`mamber2`='".$this->Escape($this->mamber2)."',
			`st_examp2`='".$this->Escape($this->st_examp2)."',
			`relation2`='".$this->Escape($this->relation2)."',
			`education2`='".$this->Escape($this->education2)."',
			`occupation2`='".$this->Escape($this->occupation2)."',
			`mamber3`='".$this->Escape($this->mamber3)."',
			`st_examp3`='".$this->Escape($this->st_examp3)."',
			`relation3`='".$this->Escape($this->relation3)."',
			`education3`='".$this->Escape($this->education3)."',
			`occupation3`='".$this->Escape($this->occupation3)."',
			`mamber4`='".$this->Escape($this->mamber4)."',
			`st_examp4`='".$this->Escape($this->st_examp4)."',
			`relation4`='".$this->Escape($this->relation4)."',
			`education4`='".$this->Escape($this->education4)."',
			`occupation4`='".$this->Escape($this->occupation4)."',
			`mamber5`='".$this->Escape($this->mamber5)."',
			`st_examp5`='".$this->Escape($this->st_examp5)."',
			`relation5`='".$this->Escape($this->relation5)."',
			`education5`='".$this->Escape($this->education5)."',
			`occupation5`='".$this->Escape($this->occupation5)."',
			...
			`st_hobbies`='".$this->Escape($this->st_hobbies)."',
			`st_attach1`='".$this->Escape($this->st_attach1)."',
			`st_attach2`='".$this->Escape($this->st_attach2)."',
			`st_attach3`='".$this->Escape($this->st_attach3)."',
			`st_attach4`='".$this->Escape($this->st_attach4)."',
			...
			`intdate`='".$this->intdate."', 
			`image`='".$this->Escape($this->image)."', 
			`selstatus`='".$this->selstatus."', 
			`tcstatus`='".$this->Escape($this->tcstatus)."', 
			`st_username`='".$this->Escape($this->st_username)."', 
			`st_password`='".$this->Escape($this->st_password)."', 
			`st_theme`='".$this->Escape($this->st_theme)."', 
			`st_class`='".$this->Escape($this->st_class)."', 
			`st_subject`='".$this->Escape($this->st_subject)."', 
			...
			`st_permissions`='".$this->Escape($this->st_permissions)."', 
			`st_bloodgroup`='".$this->Escape($this->st_bloodgroup)."', 
			`teach_nonteach`='".$this->teach_nonteach."', 
			`hrdsid`='".$this->Escape($this->hrdsid)."' where `es_staffid`='".$this->es_staffId."'";
		}
		else
		{
			$this->pog_query = "insert into `es_staff` (`st_postaplied`, `st_firstname`, `st_lastname`, `st_gender`, `st_fthname`, `st_dob`, `st_primarysubject`, `st_fatherhusname`, `st_noofdughters`, `st_noofsons`, `st_marital`, `st_experience`, `st_category`, `st_email`, `st_mobilenocomunication`, `st_examp1`, `st_examp2`, `st_examp3`,`mamber1`, `age1`, `relation1`,`education1`, `occupation1`, `mamber2`, `age2`, `relation2`, `education2`, `occupation2`, `mamber3`, `age3`, `relation3`, `education3`, `occupation3`, `mamber4`, `age4`, `relation4`, `education4`, `occupation4`, `mamber5`, `age5`, `relation5`, `education5`, `occupation5`,`st_borduniversity1`, `st_borduniversity2`, `st_borduniversity3`, `st_year1`, `st_year2`, `st_year3`, `st_insititute1`, `st_insititute2`, `st_insititute3`, `st_position1`, `st_position2`, `st_position3`, `st_period1`, `st_period2`, `st_period3`, `st_pradress`, `st_hobbies`, `st_attach1`, `st_attach2`, `st_attach3`, `st_attach4`, `st_prcity`, `st_prpincode`, `st_prphonecode`, `st_prstate`, `st_prresino`, `st_prcountry`, `st_prmobno`, `st_peadress`, `st_pecity`, `st_pepincode`, `st_pephoneno`, `st_pestate`, `st_peresino`, `st_pecountry`, `st_pemobileno`, `st_refposname1`, `st_refposname2`, `st_refposname3`, `st_refdesignation1`, `st_refdesignation2`, `st_refdesignation3`, `st_refinsititute1`, `st_refinsititute2`, `st_refinsititute3`, `st_refemail1`, `st_refemail2`, `st_refemail3`, `st_writentest`, `st_technicalinterview`, `st_finalinterview`, `status`, `st_perviouspackage`, `st_basic`, `st_dateofjoining`, `st_post`, `st_department`, `st_remarks`, `intdate`, `image`, `selstatus`, `tcstatus`, `st_username`, `st_password`, `st_theme`, `st_class`, `st_subject`, `st_qualification`, `st_marks1`, `st_marks2`, `st_marks3`, `st_permissions`, `st_bloodgroup`, `teach_nonteach`, `hrdsid` ) values (
			'".$this->Escape($this->st_postaplied)."', 
			'".$this->Escape($this->st_firstname)."', 
			'".$this->Escape($this->st_lastname)."', 
			'".$this->Escape($this->st_gender)."', 
			'".$this->Escape($this->st_fthname)."',
			...
			'".$this->Escape($this->st_marital)."', 
			'".$this->Escape($this->st_experience)."', 
			'".$this->Escape($this->st_category)."', 
			...
			'".$this->Escape($this->mamber1)."',
			'".$this->Escape($this->age1)."',
			'".$this->Escape($this->relation1)."',
			'".$this->Escape($this->education1)."',
			'".$this->Escape($this->occupation1)."',
			'".$this->Escape($this->mamber2)."',
			'".$this->Escape($this->age2)."',
			'".$this->Escape($this->relation2)."',
			'".$this->Escape($this->education2)."',
			'".$this->Escape($this->occupation2)."',
			'".$this->Escape($this->mamber3)."',
			'".$this->Escape($this->age3)."',
			'".$this->Escape($this->relation3)."',
			'".$this->Escape($this->education3)."',
			'".$this->Escape($this->occupation3)."',
			'".$this->Escape($this->mamber4)."',
			'".$this->Escape($this->age4)."',
			'".$this->Escape($this->relation4)."',
			'".$this->Escape($this->education4)."',
			'".$this->Escape($this->occupation4)."',
			'".$this->Escape($this->mamber5)."',
			'".$this->Escape($this->age5)."',
			'".$this->Escape($this->relation5)."',
			'".$this->Escape($this->education5)."',
			'".$this->Escape($this->occupation5)."',
			...
			'".$this->Escape($this->st_hobbies)."', 
			'".$this->Escape($this->st_attach1)."',
			'".$this->Escape($this->st_attach2)."',
			'".$this->Escape($this->st_attach3)."',
			'".$this->Escape($this->st_attach4)."',
