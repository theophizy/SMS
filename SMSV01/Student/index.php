            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
             <?php
               if(!empty($studentAction->image)){
                    ...
                    <img src="<?php echo $studentAction->image;?>" width="50" height="50">
                   <?php }else{?>
            ...
            <ul class="dropdown-menu">
              ...
              <?php
               if(!empty($studentAction->image)){
                    ...
                    <img src="<?php echo $studentAction->image;?>" width="80" height="80">
                    <?php }?>
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="student_profile.php" target="iframe_info" class="btn btn-default btn-flat">Profile</a>
                   
                </div>
                <div class="pull-right">
                <a href="javascript:;" data-toggle="modal" data-target="#confirmModal" class=" btn btn-default btn-flat">Sign Out</a>
                </div>
              </li>
            </ul>
          </li>
       ...
       <!--  <li class="header">MAIN NAVIGATION</li>-->
        <!-- <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="view_term_duration.php" target="iframe_info"><i class="fa fa-circle-o"></i> View Term Duration</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="student_view_staff_profile.php" target="iframe_info"><i class="fa fa-circle-o"></i> View Staff Profile</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="resultsheet1.php" target="iframe_info"><i class="fa fa-circle-o"></i> View Current session Result</a></li>
           <!-- <li><a href="resultsheet_past_student.php" target="iframe_info"><i class="fa fa-circle-o"></i> View Past Session Result</a></li> -->
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="view_current_fee.php" target="iframe_info"><i class="fa fa-circle-o"></i> View Current Fee</a></li>
            <li><a href="payment_history.php" target="iframe_info"><i class="fa fa-circle-o"></i> Payment History </a></li>
           <li><a href="debtor_history.php" target="iframe_info"><i class="fa fa-circle-o"></i> Debts  </a></li>
          </ul>
        </li>
