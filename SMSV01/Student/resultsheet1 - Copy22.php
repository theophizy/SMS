...
$total_subjects_by_student = $createscore->number_subjects_student_enrolled();
	...
	echo $school_setup->remark_session.$school_setup->remark_term;
...
$student_averages =  floor(($createscore->avg_total_marks/$total_subjects_by_student ));
$student_remark = $school_setup->getStudentRemarkByTermandSession($student_averages);
?>
...
$getpublis = $createscore->AvoidPublisDuplicate($publish_code);
	 ...
	 if( isset($getpublis) && $getpublis <= 0) {
		 echo " <div class='btn btn-danger btn-block' id='msgdiv'>The selected term and session results has not been  published. </div>";
	 }else{
?>
<center>
    ...
    <tr>
		<td>
			...
			?>
              ...
              <tr><td><font size="+1"><i>Form Master's Remark:</i></font></td><td colspan="4"><?php echo ucwords($student_remark); ?></td></tr> 
			</table>   
		</td>
		</tr></table>
