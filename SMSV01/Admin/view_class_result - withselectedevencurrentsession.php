...
$classarm->viewClassArmByID();	   
 ...
 ?>
                      ...
                      <?php }} ?>
                     <td><button title="View Scores Details" class="" data-toggle="modal" type="button" data-target="#update_modal<?php echo $student_admission_no?>"><span class=" btn-default fa fa-eye"></span></button>
                      <!--<button title="View Scores Details" class=""  onClick="show(<?php echo $student_term?>,<?php echo $students_class ?>,<?php echo $session?>,<?php echo $students_classarm?>,<?php echo $studentAction->student_regno ?>);"><span class=" btn-default fa fa-eye"></span></button> -->
                      <a href="grade_cognitive_skills.php?student_term=<?php echo $student_term?>&students_class=<?php echo $students_class ?>&session=<?php echo $session?>&students_classarm=<?php echo $students_classarm?>&regno=<?php echo $student_admission_no ?>"  title="Grade Student Cognitive Skills"><span class="btn btn-success fa fa-pencil" ></span></a>
                   <!--<button title="View Scores Details" class=""  onClick="showResult(<?php echo $student_term?>,<?php echo $students_class ?>,<?php echo $session?>,<?php echo $students_classarm?>,<?php echo $studentAction->student_regno ?>);"><span class=" btn-default fa fa-eye"></span></button> -->
                     <a href="view_student_results.php?student_term=<?php echo $student_term?>&students_class=<?php echo $students_class ?>&session=<?php echo $session?>&students_classarm=<?php echo $students_classarm?>&admission_no=<?php echo $studentAction->student_regno ?>"  title="View Student Result"><span class=" btn btn-success fa fa-eye-slash" ></span></a>
