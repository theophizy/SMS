...
?></div><div class="clearfix"></div>
        <!-- Left Panel -->
         ...
         <h2>Close each class scores at the end of each term</h2>
<form class="form-group" method="post" action="../Control_classes/Scores_controller.php?action=close_scores">

<input type="submit" name="post" value="Close term scores" class="btn btn-primary btn-block">
</form>
        </div> <!-- .content -->
    </div><!-- /#right-panel -->
