...
?></div><div class="clearfix"></div>
 ...
 <div class="col-lg-10">
                    ...
                    <div class="card">
                     <div class="btn btn-reddit btn-block"> <strong>Create Subject </strong> </div>
                        <strong><hr></strong>
                       
                      
                      <div class="card-body card-block">
                        <form action="../Control_classes/subject_controller.php?action=createsubject" method="post" enctype="multipart/form-data" class="form-horizontal" name="postForm" onSubmit="return ValidatePost();">
                           
                            
                           <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Subject Code</label></div>
                            <div class="col-3 col-md-4"><input type="text" id="subject_code" name="subject_code" placeholder="E.g MATH or ENG" class="form-control"   required></div>
                          </div>
 
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Subject Name</label></div>
                            <div class="col-3 col-md-4"><input type="text" id="subject_name" name="subject_name" placeholder="E.g Mathematics" class="form-control"   required></div>
                          </div>
