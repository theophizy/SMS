...
$classarm->viewClassArmByID();	   
 ...
 ?>
                      ...
                      <?php }} ?>
                     <td><button title="View Scores Details" class="" data-toggle="modal" type="button" data-target="#update_modal<?php echo $student_admission_no?>"><span class=" fa fa-eye"></span></button>
                     <button title="Grade Student Cognitive Skills"  onClick="show(<?php echo $student_term?>,<?php echo $students_class ?>,<?php echo $session?>,<?php echo $students_classarm?>,<?php echo $studentAction->student_regno ?>);"><span class="btn btn-primary fa fa-pencil"></span></button>
                     <button title="View student result" onClick="showResult(<?php echo $student_term?>,<?php echo $students_class ?>,<?php echo $session?>,<?php echo $students_classarm?>,<?php echo $studentAction->student_regno ?>);"><span class="btn btn-default fa fa-eye"></span></button>  
