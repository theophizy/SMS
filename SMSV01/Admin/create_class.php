...
?></div><div class="clearfix"></div>
 ...
 <div class="col-lg-10">
                    ...
                    <div class="card">
                    <div class="btn btn-reddit btn-block"> <strong>Create Class</strong> </div>
                     
                        <strong><hr></strong> 
                    
                      
                      <div class="card-body card-block">
                        <form action="../Control_classes/class_controller.php?action=createclass" method="post" enctype="multipart/form-data" class="form-horizontal" name="postForm" onSubmit="return ValidatePost();">
