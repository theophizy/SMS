...
<head>
 ...
 <script type="text/javascript">
	...
	function show(id){
		window.open('update_products.php?id='+id,'Update student information','scrollbars=yes,resizable=yess,top=500,width=500,left=500,height=500');
 ...
 <div class="col-lg-10">
                    ...
                    <div class="card">
                      <div class="card-header" align="center">
                        <strong>Chanege Password</strong> 
                        <br>
                      </div>
