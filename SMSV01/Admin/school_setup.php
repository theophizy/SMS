                      ...
                      <div class="card-body card-block">
                        <form action="../Control_classes/schoolsetup_controller.php?action=Update_school" method="post" enctype="multipart/form-data" class="form-horizontal" name="postForm" onSubmit="return ValidatePost();">
                           ...
                           <div class="row form-group">
                            ...
                            <div class="col-3 col-md-4"><input type="text" id="school_name" name="school_name" class="form-control" value="<?php echo $availablecognitiveskills->school_name  ?>"  onKeyUp="this.value=this.value.toUpperCase();" required></div>
                          </div>
 
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">SCHOOL ADDRESS</label></div>
                            <div class="col-3 col-md-4"><textarea  id="school_address" name="school_address" class="form-control" required> <?php echo $availablecognitiveskills->school_address ?></textarea></div>
                          </div>
                          <div class="row form-group">
                          <div class="col col-md-3"><label for="text-input" class=" form-control-label">SCHOOL PHONE</label></div>
                            <div class="col-3 col-md-4"><input type="number" id="school_phone" name="school_phone" class="form-control"  value="<?php echo $availablecognitiveskills->school_phone  ?>"  required></div></div>
                          
                          <div class="row form-group">
                          <div class="col col-md-3"><label for="text-input" class=" form-control-label">SCHOOL EMAIL</label></div>
                            <div class="col-3 col-md-4"><input type="email" id="school_email" name="school_email" class="form-control"  value="<?php echo $availablecognitiveskills->school_email  ?>"   required></div>
                          </div>
                          <div class="row form-group">
                           <div class="col col-md-3"><label for="text-input" class=" form-control-label">SCHOOL LOGO</label></div>
                            <div class="col-3 col-md-4"><input type="file" name="file" class="form-control" value="<?php echo $availablecognitiveskills->school_logo ?>" > <img class="user-avatar rounded-circle" src="<?php echo $availablecognitiveskills->school_logo?>" style="height:40; width:40px;"  alt="User Avatar"></div>
                          </div>
