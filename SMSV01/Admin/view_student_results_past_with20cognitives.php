		...
		<td>
			...
			?>
               ...
               <?php	
                ...
                <tr bgcolor="#ddd"><td>COGNITIVE SKILL</td><td>1</td><td>2</td><td>3</td><td>4</td><td>5</td></tr>
                 <?php 
				if(!empty($school_setup->viewAllHistoryCognitiveSkillswithOffset(5,10))){
				foreach($school_setup->viewAllHistoryCognitiveSkillswithOffset(5,10) as $key => $val){ $cognitive_id = $val['cognitive_id'];
				$school_setup->cog_id = $cognitive_id;
				$school_setup->viewCog_student_skills();
			$item_selected = $val['cog_student_item'];
			?>
               ...
               <?php	
                ...
                <tr bgcolor="#ddd"><td>COGNITIVE SKILL</td><td>1</td><td>2</td><td>3</td><td>4</td><td>5</td></tr>
                 <?php 
				if(!empty($school_setup->viewAllHistoryCognitiveSkillswithOffset(5,15))){
				foreach($school_setup->viewAllHistoryCognitiveSkillswithOffset(5,15) as $key => $val){ $cognitive_id = $val['cognitive_id'];
				$school_setup->cog_id = $cognitive_id;
				$school_setup->viewCog_student_skills();
				$item_selected = $val['cog_student_item'];
			?>
