...
<div class="btn btn-reddit btn-block"> <strong>Availabe Terms</strong> </div>
                ...
                <div class="table-responsive" >  
                     <div align="right">  
                          <button type="button" name="add" id="add" data-toggle="modal" data-target="#add_data_Modal" class="btn btn-warning">Add new Term</button>  
                     </div>  
                     <br />  
                   <div class="box">
              ...
              <table id="example1" class="table table-bordered table-striped">
                <thead>
				  ...
				  ?>
                     ...
                     <td><button title="Edit" class="btn-success" data-toggle="modal" type="button" data-target="#update_modal<?php echo $val['term_code']?>"><span class=" fa fa-pencil"></span></button></td> </tr>
  <div class="modal fade" id="update_modal<?php echo $val['term_code']?>" aria-hidden="true">
	<div class="modal-dialog">
	<div class="modal-content">
<form method="POST" action="../Control_classes/term_controller.php?action=Edit_term">
				<div class="modal-header">
                <div class="btn btn-reddit btn-block"> <strong>Edit Term</strong> </div>
				...
				<div class="modal-body">
                            ...
                            <div class="col-3 col-md-3"><label>Term Name</label>
							<input type="hidden" name="term_code" value="<?php echo $val['term_code']?>"/></div>
                             
                            <div class="col-3 col-md-8">
<input type="text" name="term_name" value="<?php echo $val['term_name']?>" class="form-control"  onkeyup="this.value= this.value.toUpperCase();" required />
						</div>
