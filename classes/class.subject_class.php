...
class Subject_class extends StudentClasses{
...
function binded_subject_class_field(){
		...
		$this->query = "SELECT d.class_sub_code,d.class_sub_class_code,class_sub_subject_code,e.subject_name FROM ".$this->table." d JOIN `sms_subject`e ON d.class_sub_subject_code=e.subject_id WHERE d.class_sub_class_code='".$this->class_sub_class_code."'";
