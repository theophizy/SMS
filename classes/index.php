       ...
       <!--  <li class="header">MAIN NAVIGATION</li>-->
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="resultsheet_student.php" target="iframe_info"><i class="fa fa-circle-o"></i> View Result</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="view_sudent_subjects.php" target="iframe_info"><i class="fa fa-circle-o"></i> View Your Subjects</a></li>
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-user-circle"></i> <span>Form Teacher</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="class_your_master.php" target="iframe_info"><i class="fa fa-circle-o"></i> View Your Form Teacher</a></li>
