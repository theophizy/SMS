   ...
   ?>
     ...
     <div class="table-responsive" >  
            ...
            <div class="box-header">
              <h3 class="box-title">Class: <?php echo $studentclass->class_name.$classarm->class_arm_name?> &nbsp;&nbsp;&nbsp;</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
 ...
 foreach($studentAction->viewStudentbyClassandClassarm() as $key => $values){
				...
				$studentAction->student_regno =  $values['student_regno'];
				  ...
				  ?>
                   ...
                   <button title="Update Student Records" onClick="show(<?php echo $studentAction->student_regno?>)"></span></span><span class=" btn-primary fa fa-pencil" ></span></button>
