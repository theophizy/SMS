 ...
 <div class="col-lg-10">
                    ...
                    <div class="card">
                      <div class="card-header" align="center">
                        <strong>Bind subject to classes</strong> 
                      </div>
                      ...
                      <div class="card-body card-block">
                        <form action="../Control_classes/class_subject_controller.php?action=bindclasstosubjects" method="post" enctype="multipart/form-data" class="form-horizontal" name="postForm" onSubmit="return ValidatePost();">
                          ...
                          <p>Fields mark <font color="#FF0000">*</font> are compulsory </p> 
 
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Class <font color="#FF0000">*</font> </label></div>
                            <div class="col-3 col-md-4"><?php echo $studentclass->classSelectField(); ?></div>
                          </div>
                          
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Class Arm<font color="#FF0000">*</font> </label></div>
