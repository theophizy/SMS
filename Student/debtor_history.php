...
?></div><div class="clearfix"></div>
 ...
 <div class="col-lg-12">
                    ...
                    <div class="card">
                    <div class="btn btn-reddit btn-block"> <strong> Student's Debts </strong> </div><strong><hr></strong>  
      
   <?php
  
  $feeItem->fee_regno = $_SESSION['USERNAME'];
	if(!empty($feeItem->viewStdentDebts())){
 ...
 foreach($feeItem->viewStdentDebts() as $key => $values){
