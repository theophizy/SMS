...
<head>
	...
	function show(id){
		...
		window.open('Receipt2.php?id='+id,'Alumni Payment History','scrollbars=yes,resizable=yess,top=500,width=700,left=500,height=700');
...
?></div><div class="clearfix"></div>
 ...
 <div class="col-lg-12">
                    ...
                    <div class="card">
                     <div class="btn btn-reddit btn-block"> <strong> Student's Payments History</strong> </div><strong><hr></strong> 
      
   <?php
  
  
	  $feeItem->fee_regno = $_SESSION['USERNAME'];
	if(!empty($feeItem->viewPaymentbyStudentRegistrationNumber())){
 ...
 foreach($feeItem->viewPaymentbyStudentRegistrationNumber() as $key => $values){
