...
$student_term = $term->current_term;
 ...
 $students_class = $studentAction->student_class;
 $students_classarm = $studentAction->student_classarm;
 ...
 // id for student's total marks obtained in a particular term in sms_average_score model
  ...
  $result_privilege = $createscore->result_view;
    //get principal
...
$principal_remark = $school_setup->getStudentPrincipalRemarkByTermandSession($student_averages);
$attendance;
...
$getpublis = $createscore->AvoidPublisDuplicate($publish_code);
	 ...
	 }elseif( $result_privilege === "INACTIVE"){
		 echo " <div class='btn btn-danger btn-block' id='msgdiv'>Pls you are not granted access to view your result for none payment of examination fee . </div>"; 
	 }else{
?>
<center>
	<table border=1 style=" max-width:2480px; width:100%; height:auto;" id="printDiv">
		<tr>
		<td>
			<table  width="100%">
			<tr>
