       ...
       <!--  <li class="header">MAIN NAVIGATION</li>-->
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="resultsheet1.php" target="iframe_info"><i class="fa fa-circle-o"></i> View Result</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="view_current_fee.php" target="iframe_info"><i class="fa fa-circle-o"></i> Pending Fee</a></li>
