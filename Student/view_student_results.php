...
<center>
	...
	$sn=0;
		...
		$suffix = $createscore->print_suffix($position);
		 ...
		 ?>
				<tr bgcolor="<?php echo $bg_color  ?>"><td><?php echo $sn; ?></td><td><?php echo ucwords($subject->subject_name) ?></td><td><?php echo $values['score_CA1']  ?></td><td><?php echo $values['score_CA2']  ?></td><td><?php echo $values['score_CA3']  ?></td><td><?php echo $values['score_exam']  ?></td><td><?php echo $values['score_total']  ?></td><td><?php echo $maximun_score; ?></td><td><?php echo $minimum_score; ?></td><td><?php echo $position  ?><sup><?php echo $suffix  ?></sup></td><td><?php echo $getgrade->grade_name; ?></td><td><?php echo $getgrade->grade_remark; ?></td></tr>
